<div x-data="{isOpen: false}">
    ...
    <div id="chat-wrapper" data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" x-bind:class="isOpen ? 'chat--visible' : ''" class="chat-wrapper chat-wrapper--ready shadow border-top border-left border-right">
