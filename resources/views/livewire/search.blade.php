<div x-data="{isOpen: false}">
    ...
    <div class="search-overlay-top shadow-sm">
      <div class="container container--narrow">
        ...
        <input x-on:keydown="document.querySelector('.circle-loader').
        ...
        class="close-live-search"><i class="fas fa-times-circle"></i></span>
      </div>
    </div>
    ...
    <div class="search-overlay-bottom">
      <div class="container container--narrow py-3">
        ...
        ({{count($results)}} {{count($results) > 1 ? "results" : "result"}} found)</div>
